# Contributing to @dhealth/uri-library

First off, thank you for considering contributing to @dhealth/uri-library. 
It’s people like you that make @dhealth/uri-library such a great tool.

@dhealth/uri-library is an open source project and we love to receive contributions from 
...
writing code which can be incorporated into @dhealth/uri-library itself.
...
If you think you have found a bug in @dhealth/uri-library, first make sure that you 
are testing against the latest version of @dhealth/uri-library - your issue may already 
...
If you find yourself wishing for a feature that doesn't exist in @dhealth/uri-library, 
you are probably not alone. There are bound to be others out there with similar 
needs. Many of the features that @dhealth/uri-library has today have been added because 
our users saw the need. Open an [issue](github-issues) on our issues list on GitHub which describes 
the feature you would like to see, why you need it, and how it should work.

## Contributing code and documentation changes

If you have a bugfix or new feature that you would like to contribute to @dhealth/uri-library, please find or open an issue 
...
You will need to fork the main @dhealth/uri-library code repository and clone 
...
Then sit back and wait. There will probably be discussion about the pull request and, if any changes are needed, we would love to work with you to get your pull request merged into @dhealth/uri-library.
...
[github-issues]: https://github.com/dhealthproject/dhealth-uri-library/issues
